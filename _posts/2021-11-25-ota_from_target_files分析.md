...
```
   ...
   1. 5.1 systemDiff 的计算与写入以下两部分，实际是在 common.py 中执行的。
   ...
   ```
   3. 5.3 common._WritePostInstallVerifyScript
   ```
